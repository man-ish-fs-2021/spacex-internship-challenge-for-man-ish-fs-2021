...
function LoadingState() {
  return (
    <>
      <table className="loading-state-table">
        <thead className="loading-state-table-head">
          <tr className="loading-state-table-row"></tr>
        </thead>
        <div className="loading-state-table-body">
          <svg
